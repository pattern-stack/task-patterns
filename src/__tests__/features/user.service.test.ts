...
describe('UserService', () => {
  ...
  describe('getByEmail', () => {
    it('should return user when found by email', async () => {
      ...
      mockClient.users = jest.fn().mockResolvedValue(
        createMockUserConnection([mockUser])
      );
  ...
  describe('list', () => {
    it('should list users with no filters', async () => {
      ...
      mockClient.users = jest.fn().mockResolvedValue(
        createMockUserConnection(mockUsers)
      );
  ...
  describe('update', () => {
    it('should update user successfully', async () => {
      ...
      mockClient.user = jest.fn().mockResolvedValue(mockUser);
      mockClient.updateUser = jest.fn().mockResolvedValue(
    ...
    it('should throw ValidationError when update fails', async () => {
      ...
      await expect(
        service.update('user-123', { displayName: 'New Name' })
  ...
  describe('updateViewer', () => {
    ...
    it('should throw ValidationError when viewer update fails', async () => {
      ...
      await expect(
        service.updateViewer({ displayName: 'New Name' })
      ).rejects.toThrow(ValidationError);
    });
  });
  ...
  describe('getAssignedIssues', () => {
    it('should return issues assigned to user', async () => {
      ...
      mockClient.issues = jest.fn().mockResolvedValue(
  ...
  describe('getComments', () => {
    it('should return comments by user', async () => {
      ...
      mockClient.comments = jest.fn().mockResolvedValue(
        createMockConnection(mockComments)
      );
  ...
  describe('getTeams', () => {
    it('should return teams for user', async () => {
      ...
      mockClient.teams = jest.fn().mockResolvedValue(
        createMockTeamConnection(mockTeams)
      );
  ...
  describe('addToTeam', () => {
    it('should add user to team successfully', async () => {
      ...
      mockClient.createTeamMembership = jest.fn().mockResolvedValue(
        createMockPayload(true, mockMembership)
      );
    ...
    it('should throw ValidationError when adding to team fails', async () => {
      ...
      await expect(
        service.addToTeam('user-123', 'team-123')
      ).rejects.toThrow(ValidationError);
    });
  });
  ...
  describe('removeFromTeam', () => {
    it('should remove user from team successfully', async () => {
      ...
      mockClient.teamMemberships = jest.fn().mockResolvedValue(
        createMockConnection([mockMembership])
      );
      mockClient.deleteTeamMembership = jest.fn().mockResolvedValue(
    ...
    it('should throw ValidationError when removal fails', async () => {
      ...
      await expect(
        service.removeFromTeam('user-123', 'team-123')
      ).rejects.toThrow(ValidationError);
    });
  });
  ...
  describe('updateSettings', () => {
    it('should update user settings successfully', async () => {
      ...
      mockClient.user = jest.fn().mockResolvedValue(mockUser);
      mockClient.updateUserSettings = jest.fn().mockResolvedValue(
        createMockPayload(true, updatedSettings)
      );
    ...
    it('should throw ValidationError when settings update fails', async () => {
      ...
      await expect(
        service.updateSettings('user-123', { timezone: 'UTC' })
      ).rejects.toThrow(ValidationError);
    });
  });
