import type { Comment, LinearDocument } from '@linear/sdk';

type CommentCreateInput = LinearDocument.CommentCreateInput;
type CommentUpdateInput = LinearDocument.CommentUpdateInput;
